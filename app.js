...
const stringSession = new StringSession("");
...
const Grupos = [
{ chat: "CONSULTAR_AQUI", comando: 'nome',bot:'Arcadian01Robot'},
{ chat: "CONSULTAR_AQUI", comando: 'cpf',bot:'Arcadian01Robot'},
{ chat: "CONSULTAR_AQUI", comando: 'placa',bot:'Arcadian01Robot'},
{ chat: "CONSULTAR_AQUI", comando: 'telefone',bot:'Arcadian01Robot'},
...
str = str.replace(/\𝙏𝙀𝙉𝙃𝘼 𝘾𝙊𝙉𝙎𝙐𝙇𝙏𝘼𝙎 𝘾𝙊𝙈𝙋𝙇𝙀𝙏𝘼𝙎 𝘼𝙏𝙐𝘼𝙇𝙄𝙕𝘼𝘿𝘼𝙎𝘾𝙊𝙈 𝙏𝙊𝙏𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘾𝙄𝘿𝘼𝘿𝙀 𝘾𝙊𝙉𝙏𝙍𝘼𝙏𝘼𝙉𝘿𝙊 𝙐?? 𝘿𝙀 𝙉𝙊𝙎??𝙊𝙎 𝙋𝘼𝙄𝙉𝙀́𝙄𝙎 𝙋𝙇𝘼𝙉𝙊𝙎 𝘼 𝙋𝘼𝙍𝙏𝙄𝙍 𝘿𝙀 30 𝙍𝙀𝘼𝙄𝙎/g, '');
